...
export function Dashboard() {
  ...
  const stats = [
    { label: 'Total Revenue', value: '$12,450', icon: DollarSign, color: 'text-accent', bg: 'bg-accent/10' },
    { label: 'Active Bookings', value: '24', icon: Users, color: 'text-primary', bg: 'bg-primary/10' },
    { label: 'Occupancy Rate', value: '78%', icon: TrendingUp, color: 'text-warning', bg: 'bg-warning/10' },
  ];

  const parkingLots = [
    { id: 1, name: 'Downtown Plaza', address: '123 Main St', spots: '45/67', revenue: '$2,340', status: 'available' as const },
    { id: 2, name: 'City Mall', address: '456 Oak Ave', spots: '32/50', revenue: '$1,890', status: 'available' as const },
    { id: 3, name: 'Airport Terminal', address: 'Airport Rd', spots: '50/50', revenue: '$3,200', status: 'occupied' as const },
  ];
